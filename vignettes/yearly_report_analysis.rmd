...
res_plotter_double(res = res_matrix, y = y, xlab = '5-Day Price Change', main = 'Step-Regression on Yearly Report Figures to Predict 5-Day Price Change')
```
